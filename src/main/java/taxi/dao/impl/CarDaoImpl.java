...
public class CarDaoImpl implements CarDao {
    ...
    private void insertAllDrivers(Car car) {
        List<taxi.model.Driver> drivers = car.getDrivers();
        if (drivers.size() == 0) {
            return;
        }
        ...
        try (Connection connection = ConnectionUtil.getConnection();
            ...
            for (taxi.model.Driver driver : drivers) {
    ...
    private List<taxi.model.Driver> getAllDriversByCarId(Long carId) {
        ...
        try (Connection connection = ConnectionUtil.getConnection();
            ...
            ResultSet resultSet = statement.executeQuery();
            List<taxi.model.Driver> drivers = new ArrayList<>();
            while (resultSet.next()) {
    ...
    private taxi.model.Driver parseDriverFromResultSet(ResultSet resultSet) throws SQLException {
        Long driverId = resultSet.getObject("id", Long.class);
        String name = resultSet.getString("name");
        String licenseNumber = resultSet.getString("license_number");
        String login = resultSet.getString("login");
        String password = resultSet.getString("password");
        taxi.model.Driver driver = new Driver();
